...
const CATEGORY_ORDER: GameCategory[] = ['MEMORY', 'FOCUS', 'REACTION', 'PATTERN', 'ROUTINE', 'CULTURAL', 'GENTLE', 'ADVANCED'];
...
const CATEGORY_META: Record<GameCategory, { labelKey: string; color: string; icon: string }> = {
  ...
  CULTURAL: { labelKey: 'game.category.cultural', color: '#D17A00', icon: '🪔' },
