            ...
            {insights.length > 0 ? insights.map((insight, i) => (
              <div key={i} style={{
                ...
                background: insight.includes('decreased') || insight.includes('missed') ? 'var(--color-warning-light)' :
                  insight.includes('consistently') || insight.includes('stable') ? 'var(--color-success-light)' : '#EAF5F3',
                border: `1px solid ${insight.includes('decreased') ? '#FFE0B2' : insight.includes('consistently') ? '#C8E6C9' : '#D9E9E6'}`,
